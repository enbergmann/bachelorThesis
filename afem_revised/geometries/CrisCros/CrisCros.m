function CrisCros()
% CRISCROS The Square geometry with pure Dirichlet boundary. In the
...
%
% Example:
% [c4n n4e n4sDb n4sNb] = loadGeometry('CrisCros',1);
%
% See also SQUARE, SQUARENB, SQUARENB2, BIGSQUARE
%
