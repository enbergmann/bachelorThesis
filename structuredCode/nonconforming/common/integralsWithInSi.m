...
%% MAIN
  ...
  int1InSi4e = integrate(c4n, n4e, @(n4p, Gpts4p, Gpts4ref)(...
    f(Gpts4p).*(1 - 2*funcLambda3(Gpts4p))), degree4Integrate, area4e);
  int2InSi4e = integrate(c4n, n4e, @(n4p, Gpts4p, Gpts4ref)(...
    f(Gpts4p).*(1 - 2*funcLambda1(Gpts4p))),  degree4Integrate, area4e);
  int3InSi4e = integrate(c4n, n4e, @(n4p, Gpts4p, Gpts4ref)(...
    f(Gpts4p).*(1 - 2*funcLambda2(Gpts4p))), degree4Integrate, area4e);
