...
\input{chapters/iterativeSolve.tex}

\section{Numerical Examples}
\input{chapters/experiments.tex}

\begin{frame}
  End slide with some picture maybe or just end on the last slide
  in experiments (with might be a plot with everything in it, which 
  would be nice
\end{frame}
