function adaptivProlongation(red,terminate)
  ...
  miscMsg = 'adaptiv algorithm with prolongation';
  expName = 'adaptivTestProlongation';
  ...
  while( true )
    ...
    % REFINE
    [c4nNew,n4eNew,n4sDb,n4sNb] = refineRGB(c4n,n4e,n4sDb,n4sNb,n4sMarked);
