...
\begin{tikzpicture}
  ...
  \begin{loglogaxis}[
    ...
    % eta
    add slope triangle
    \draw (axis cs:7e5, 4e-1)
                 -- (axis cs:7e5, 4e-2) node [midway, right] {\scriptsize$1$}
                 -- (axis cs:7e3, 4e-1)
    ...
    \draw (axis cs:7e5, 4e-1)
                 -- (axis cs:7e3, 4e0) 
                 -- (axis cs:7e3, 4e-1) node [midway, left] {\scriptsize$1$} 	 
                 -- cycle
                 ;

    % error
    add slope triangle
    \draw (axis cs:2e5, 2e-5)
                 -- (axis cs:2e3, 2e-5) node [midway, below] {\scriptsize$1$}
                 -- (axis cs:2e3, 2e-3) node [midway, left] {\scriptsize$1$} 	 
                 -- cycle
                 ;
