...
\begin{tikzpicture}
  \begin{loglogaxis}[
    ...
    ymajorgrids=true,
    legend entries = {
      $\left\vvvert (u_j - u_{j-1})/\tau\right\vvvert_\textup{NC}$,
      $\left\Vert (u_j - u_{j-1})/\tau\right\Vert$,
      $\left|E_\textup{NC}(u_j) - E_\textup{NC}(u_{j-1})\right|$
    ...
    \addplot [solid, red, ultra thick, filter discard warning = false, 
      skip coords between index = {1001}{1000000}]
    table[x expr = \coordindex+1, y index = 0] 
    {f01Adaptive/lvl6/iteration/bar12TerminationSqrtVec.txt}; 
    ...
    \addplot [solid, green, ultra thick, filter discard warning = false, 
      skip coords between index = {1001}{1000000}]
    table[x expr = \coordindex+1, y index = 0] 
    {f01Adaptive/lvl6/iteration/eNcAbsDiffVec.txt}; 
