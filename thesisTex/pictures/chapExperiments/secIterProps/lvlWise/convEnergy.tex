...
\DTLloaddb{db}{f01Adaptive/paramsReduced.csv} 
...
\begin{tikzpicture}
  \begin{semilogxaxis}[
    ...
    scale = 1, 
    xlabel = {$j$},
    ylabel = {$E_\textup{NC}(u_{j-1,\mathcal{T}})$},
    ymajorgrids=true,
    legend entries = {
      Level 1 (nrDof = \nrDofA),
      Level 3 (nrDof = \nrDofB),
    ...
    {f01Adaptive/lvl1/iteration/energyVec.txt}; 

    % lvl 3
    \addplot [solid, blue, thick, filter discard warning = false, 
      skip coords between index = {1001}{1000000}]
    table[x expr = \coordindex+1, y index = 0] 
    {f01Adaptive/lvl3/iteration/energyVec.txt}; 
    ...
    \addplot [solid, green, thick, filter discard warning = false, 
      skip coords between index = {1001}{1000000}]
    table[x expr = \coordindex+1, y index = 0] 
    {f01Adaptive/lvl6/iteration/energyVec.txt}; 
    ...
    \addplot [solid, red, thick, filter discard warning = false, 
      skip coords between index = {1001}{1000000}]
    table[x expr = \coordindex+1, y index = 0] 
    {f01Adaptive/lvl14/iteration/energyVec.txt}; 
