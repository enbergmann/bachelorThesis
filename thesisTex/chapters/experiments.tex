...
\begin{figure}[!ht]
  ...
  \caption{Verfeinerungsindikator, $L^2-Fehler$ und Energiedifferenz für 
  das Eingangangssignal $f$.}
  \label{fig:parTauConvergence}
\end{figure}

Wie in \Cref{fig:parTauMisc} zu sehen, scheint sich die Anzahl der Iteration,
...
%TODO
Die Zeit in Sekunden ist, obwohl klar, geplottet, um einen Eindruck zu
vermitteln, wie lang die Laufzeit der Iteration ist selbst bei augenscheinlich
idealer Wahl von tau (bis zu
1e5 Sekunden, d.h. fast 3h, für ein Level bei f01)
%TODO
