...
Außerdem können wir nach den Überlegungen, die zu \Cref{fig:f01JumpTerms} in
\Cref{sec:experimentsWithExactSolution} aufgeschrieben werden, davon ausgehen,
...
ist, lässt die Annahme zu, dass 
das Markieren von Dreiecken mit großer Fläche kurzzeitig eine effektive
Verfeinerungsstrategie ist, insgesamt aber nicht zu geringeren exakten
Fehlern führt.
...
\subsection{Konvergenz der Iteration}
...
\subsection{Konvergenz des AFEM-Algorithmus}
