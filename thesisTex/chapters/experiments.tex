...
\begin{figure}[p]
  ...
  \begin{subfigure}[b]{.48\linewidth}
    \centering
    \caption{Zwei Graphen und ihre Differenz}
    \includegraphics[width=\linewidth]
...
Eine noch stärkere Regularitätsanname verbessert die Raten also nicht weiter,
es werden aber geringfügig kleinere Werte erreicht.
