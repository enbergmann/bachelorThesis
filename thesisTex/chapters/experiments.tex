...
$, 
mit
der wir die Ergebnisse der Experimente vergleichen können.
\begin{figure}[p]
  \centering
...
Skalierugsunterschiede im Beweis von Lemma \ldots)
==================
...
vlt noch einen plot in der anzahl der iteration verglichen werden für f01,
f01LargeAlpha und f04 (natürlich alle mit $\tau=1$, weil möglicherweise (das
dann mal gucken) f01LargeAlpha die wenigsten Iteration braucht (obwohl ähnlich
zu f01 (insb. gleiche Lösung) und obwohl f04 regulärer). das kann dann wieder
mit der erwarteten Ungleichung aus dem Konvergenzbeweis begründet werden (also
sagen, dass man hier ein weiteres Indiz für diese Hypothese ht.
