...
anstelle der Energienorm verwendet wird, nur um einen Faktor von ungefähr
...
Entsprechend ist davon auszugehen, dass bei Wahl dieses Abbruchkriteriums 
nur die Toleranz $\epsstop$ angepasst werden müsste.
Die andere Variante, das heißt der Betrag der Differenz der nichtkonformen
Energien zweier Iterate, scheint sich aber,
...
Nach \cite[S. 309, Theorem 10.7]{Bar15} erwarten wir für die dort betrachtete
Version des Problem, das heißt der Diskretisierung mit
