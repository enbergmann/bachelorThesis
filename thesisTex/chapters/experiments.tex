...
\Cref{fig:f01Convergence} gilt $u,f_1\in H^1_0\left( (-1,1)^2 \right)$. 
...
Raten weiter verbessern können, betrachten wir nun die Funktion
$u_\textrm{HR} \in H^2_0\left((-1,1)^2\right)$, die gegeben ist durch 
\begin{align*}
...
\begin{align*}
  ...
  \end{cases}
\end{align*}
für das ebenfalls gilt $f_\textrm{HR}\in H^2_0\left((-1,1)^2\right)$.
...
\begin{align*}
  ...
  \begin{cases}
    ...
    & \text{falls } r\in\left(\frac{1}{3}, \frac{2}{3}\right]\!,\\
    3645r^2 - 6048r + 2592 - \frac{81}{r^2}, 
    & \text{falls } r\in\left(\frac{2}{3}, \infty\right)\!,
  \end{cases}
\end{align*}
und
...
\end{figure}
In \Cref{fig:f04Convergence} stellen wir lediglich fest, dass im
...
Eine noch stärkere Regularitätsannahme scheint die Raten also nicht weiter zu
...
Freiheitsgraden, noch erkennen, wo es im Bild kaum Farbkontraste gibt und eine
...
\begin{align*}
  ...
  \begin{cases}
    ...
    & \text{falls } r\in \left(\frac{1-\beta}{2}, \frac{1+\beta}{2}\right]\!,\\
    -\frac{4}{(\beta-1)^3}\left( 32r-9(\beta+3)+\frac{3\beta+1}{r^2} \right)\!,
    & \text{falls } r\in \left(\frac{1+\beta}{2},\infty\right)\!,
  \end{cases}
\end{align*}
und
...
als auch uniforme Netzverfeinerung, dass es zwischen den Experimenten mit
...
\begin{figure}[p]
  ...
  \end{subfigure}
  \caption{Triangulierungen nach den Rechnungen mit den Eingangssignalen
...
Triangulierungen mit vergleichbar vielen Freiheitsgraden in der Regel mehr
...
Dieses ist an einigen Stellen, zum Beispiel beim Erstellen der rechten Seite des 
...
Abschließend könnte auch die Wahl der Parameters $\tau$ weiter untersucht
