...
den darin verwendeten Datenstrukturn und von den mathematischen Konzepten
hinter dessen Methoden vorhanden sein. 
...
Mit $H^1(\Tcal)$ bezeichnen wir den Raum der stückweisen $H^1$-Funktionen
bezeichnet.
...
In \Cref{sec:discreteProblemFormulation} wollen wir für die Diskretisierung
einer nichtkonformen Formulierung des in
\Cref{sec:continuousProblemFormulation} genannten Minimierungsproblems die
