...
Schließlich sollte ein Verständnis des AFEM-Softwarepakets \cite{Car09} und von
den mathematischen Konzepten hinter dessen Methoden vorhanden sein. 
...
Weiterhin ist der Courant-Finite-Elemente-Raum definiert als
\begin{align*}
...
Bevor wir eine Diskretisierung von \Cref{prob:continuousProblem} formulieren,
...
Basisfunktionen, $\anc$}
\todo[inline]{Eigenes CR Kapitel wenn Quelle gefunden, direkt nach BV
Funktionen Section. Wie Courant einbinden. Vielleicht section 
Courant- und Crouzeix-Raviart-Finite-Elemente-Methode}
\todo[inline]{$S^1(\Tcal)$ auch einführen (wenigstens definieren und erwähnen, 
dass das Courant ist}
