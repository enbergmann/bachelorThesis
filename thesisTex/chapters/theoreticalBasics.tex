...
des Subdifferentials einer konvexen Funktion auf einem Banachraum 
$(X,\Vert\bullet\Vert_X)$ und die dafür benötigten Begriffe zusammen.

\begin{definition}[\protect{\cite[S. 765]{Zei86}}]
  Eine Funktion $f:X\to\Rbb$ heißt konvex, wenn für alle $x,y\in X$ und alle
  $t\in[0,1]$ 
  \begin{align*}
...
\begin{remark}
  In \cite{Zei85} werden die Aussagen auf lokal konvexen Räumen 
  $X$ formuliert.
  Nach \cite[S. 781, (43)]{Zei86} sind aber alle Banachräume (B-spaces \cite[S.
  786]{Zei86}) lokal konvex. Deshalb formuliere ich hier alle Aussagen für
  Banachräume.
\end{remark}

Zunächst seien einige grundlegende Eigenschaften eingeführt  \cite{Zei86},
\cite{Zei90}
\begin{definition}
  Eine Funktion
\end{definition}
