...
Diskretisierung des in \Cref{sec:continuousProblemFormulation} genannten
Minimierungsproblems die Crouzeix-Raviart-Finite-Elemente-Methode nutzen. 
Die dafür benötigten Definitionen und Aussagen wollen wir in diesen Abschnitt
zusammentragen aus \cites{Car09b}{CGR12}{CGKNRR10}. 
...
Für den Rest dieser Abschnitts sei $U$ ein beschränktes Lip\-schitz-Gebiet.
