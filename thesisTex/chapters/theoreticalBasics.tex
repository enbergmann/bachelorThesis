...
Das folgende Theorem folgt aus Theorem 10.1.4 zusammen mit \Cref{thm:wlsc} 
wie folgt (Beweis vielleicht wirklich führen).
Nach 10.1.3 \ldots siehe Skizze auf Blatt.
(10.1.4 liefert BV kompakt in L1 (immer), also schwache Konvergenz in BV
impliziert immer starke Konvergenz in L1. Da die Folge im folgenden
Thm beschränkt ist, impliziert
\begin{theorem}
