...
des Subdifferentials einer konvexen Funktion und die dafür benötigten Begriffe
zusammen.

Zunächst seien einige grundlegende Eigenschaften eingeführt \cite[\S 1]{Roc70}.
\cite[\S 1]{Sch13}
\begin{definition}
  Eine Funktion
\end{definition}
