...
Allgemeinen nicht stetig sein müssen\todo{Quelle?}. 
...
\begin{align*}
  ...
  <
  \infty.
\end{align*}\todo{Verweis auf später?}
...
$W^{1,1}(\Omega)$ überein\todo{Quelle? Verweis auf später?}. Der zweite Term 
...
Courant-Finite-Elemente-Methode\todo{Quelle?}. Zur numerischen Lösung dieser diskreten 
...
\todo[inline]{Experimente länger rechnen und vielleicht 6 (bzw so vielen
wie möglich, sodass die Figure UND Fußnote auf eine Seite können und diese
ausfüllen) Wahlen für alpha mit
einem ernsthaften Versuch, ein gut aussehendes entrauschtes Bild zu bekommen.
Formatierung des Figure und die Captions hier überarbeiten und überlegen, wie
die Bildquelle sinnvoll zitiert werden kann (mglw. als Fußnote).}
