...
\begin{proof}
  ...
  \todo[inline]{Wie zeigt man die noch zu beweisende Gleichheit? int by parts 
  Bartels Rem 10.5 (iii). C unendlich geschnitten BV ist dicht in BV bzgl.
  stikter Konvergenz UND der Spuroperator ist stetig bzgl strikter Konvergenz.}
\end{proof}
