...
\begin{proof}
  ...
  L^2(\Omega)\subset L^1(\Omega)$, dass
...
\todo[inline]{Hier kann direkt 'starke Konvexität' hin, aus der folgt 
ebenfalls Eindeutigkeit folgt. Entsprechend den Satz vor dem vorherigen
Theorem anpassen, sowas wie ,,Eindeutigkeit folgt jeweils aus den folgenden
beiden Theoremen/kann aus einem der folgenden Theoreme gefolgt werden``}
