...
\begin{proof}
  ...
  \todo[inline]{warum beschränkt, warum folgt aus BV Norm gegen unenedlich
  auch das Normen, die in der der Abschätzung sind, gegen unendlich VIELLEICHT
  THEOREM 2.4 (lecture05 BV)}
  ...
  \todo{eigentlich nur die Seminorm nach Absch. oben}
