...
\todo[inline]{hier. Mit $\Omega$ aufpassen neu in Notations Kapitel}
\todo[inline]{Adaptiven Algorithmus nochmal komplett aufschreiben, vgl
Refinement Indicator Bild von CC}
...
Schreibe in notation Omega in R2 und mache eher sowas wie: die Aussagen hier
gelten auch,  falls Omega  beschränkte Lipschitz-Gebiet ist o.ä..
\begin{remark}
  Nach 
  %\cite[S. 399, Theorem 10.1.3]{ABM14} ist 
  \cite[S. 302, Remark 10.5 (i)]{Bar15} 
  \todo{1-regular?}
