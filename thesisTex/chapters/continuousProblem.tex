In diesen Kapitel formulieren wir unsere Variante des ROF-Modell-Problems und
beweisen, dass diese eine eindeutige Lösung besitzt. 
Außerdem beschreiben wir, wie Experimente mit bekannter Lösung konstruiert
werden können.
Für einen Parameter $\alpha\in\Rbb_+$ und eine Funktion
$f\in L^2(\Omega)$ lautet unser Minimierungsproblem wie folgt.
