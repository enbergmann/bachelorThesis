...
\begin{proof}
  ...
  $n\to\infty$. Dafür ist notwendig, dass $|u_n|\to\infty$ für $n\to\infty$, 
  also insbesondere $|u_n|\geq 1$ für hinreichend große $n\in\Nbb$. Daraus 
  ...
  sonst $E(u_n)$ bestimmt divergiert, im Widerspruch dazu, dass
  ...
  nachrechnen? DAS IST SOgAR FALsch, oder? Differenzierbarkeit muss doch 
  verloren gehen. Das ist eher eine von den BV Einbettung siehe Remark 10.5
  in Bartels oder so}
