...
der aktuellen Triangulierung $\Tcal$. 
...
Integrale $\int_T f\psi_{E_k}\!|_T\dx$, $k\in\{1,2,3\}$, bereits ermittelt
wurden.
...
\Cref{tab:paramsDoc} gewählten Ordnern.
...
\Cref{tab:paramsAFEM}, wird dies durch die Methode
\begin{center}
...
Dies geschieht wie in \Cref{sec:localNodalValuesCR} beschrieben.
...
\Cref{sec:crouzeixRaviartFunctions} beschriebenen Basis für die Triangulierung
$\hat\Tcal$.
