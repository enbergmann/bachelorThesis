...
Im Refine-Schritt nutzen wir anstelle eines Fehlerschätzers den
...
gespeichtert, die nun den Plot einer Triangulierung als Schwarz-Weiß-Bild ohne
Titel erzeugt.
...
mit genau einer Zeile möglich, das nur Buchstaben des lateinischen Alphabets
und Zahlen enthalten darf und mit einem Buchstaben beginnen muss. 
Wird die Methode ohne Übergabe eines solchen Parameters ausgeführt, nutzt
sie als Standardwert \texttt{benchmark = 'editable'}.
Nach Aufruf von \texttt{startAlgorithmCR} mit Eingabeparameter
\texttt{'benchmark'}, werden die nötigen Parameter und Einstellungen für das
jeweilige Experiment aus der Datei
\begin{center}
...
sowie die Steifig\-keits- und Massenmatix aus \Cref{rem:primalDualMatrixEquations}
