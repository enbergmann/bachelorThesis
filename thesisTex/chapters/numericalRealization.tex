...
\begin{table}
  ...
  \begin{tabular}{c|p{11.5cm}}
    ...
    \hline
    \texttt{expName} 
    & Name des Ordners, der in 
    \texttt{./../results/nonconforming/}
    zum Speichern der Ergebnisse des Programms erstellt werden soll\\
    \texttt{dirInfoName} 
    & Name des Ordners, der in
    \texttt{./../results/nonconforming/expName/}
    zum Speichern der Ergebnisse eines Levels erstellt werden soll \\
    %\texttt{errorNorm}& \\
    \hline
  \end{tabular}
...
%TODO, zu oft ,,direkt ersichtlich``
...
%TODO stimmt nicht mehr, Abbruchkriterium schon gewählt, Satz anders oder vlt
% ganz raus

% TODO computeDiscreteEnergyCR im vorherigen Abschnitt auf hier verweisen
% oder sowas ,,details zur Berechnung der diskreten Energie sind am Ende
% des folgenden Abschnitts zu finden
