...
\end{center}
Details dazu diskutieren wir in Abschnitt \ldots (verarbeite u.a. Kommentar
aus Methode für die rechte Seite $b$, auch auf Energie Berechnung darin 
eingehen und die Methode dann erwähnen, mglw mit Verweis auf eigenen Abschnitt)
