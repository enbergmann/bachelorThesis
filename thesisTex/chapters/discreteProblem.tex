...
Bevor wir die Existenz und Eindeutigkeit einer diskreten  Lösung von
...
aus der Lösung $\left( \ucr,\bar\Lambda_0 \right)\in\CR^1_0(\Tcal)\times
...
\todo{hier, Threorem aufspalten (s. Ausdruck) und weiter Tien Remarks einpflegen}
