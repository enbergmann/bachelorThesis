...
formulieren.
Dabei nutzen wir den Operator $J_1:\CR^1(\Tcal)\to P_1(\Tcal)\cap
C_0(\Omega)$ (cf.\ \cite[Section 4]{CH18}), wobei $J_1\vcr$ für eine Funktion
$\vcr\in\CR^1(\Tcal)$ in allen Innenknoten $z\in\Ncal(\Omega)$ definiert ist
durch
\begin{align}
