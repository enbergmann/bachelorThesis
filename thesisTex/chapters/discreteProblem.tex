\section{Crouzeix-Raviart-Finite-Elemente-Methode}
Bevor wir \Cref{prob:continuousProblem} diskretisieren, rufen wir uns den dafür
...
\todo[inline]{nc Differentialoperatoren, diskrete Norm/Energienorm, CR
Basisfunktionen}
...
durch 
  ...
  Programm gibt Sprungtermsumme aus, z.B. stagnierend bei 11 auf allen Leveln,
  darauf vielleicht noch kurz in der Auswertung eingehen ,man sieht, dass die
  Sprünge tatsächlch im nonkonformen Problem nicht minimiert werden oder so'}

Betrachte für einen Parameter $\alpha\in\Rbb_+$ und die rechte Seite $f\in
L^2(\Omega)$ folgende Diskretisierung von \Cref{prob:continuousProblem}. 
