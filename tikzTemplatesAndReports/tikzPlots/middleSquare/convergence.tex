...
\begin{tikzpicture}
  \begin{loglogaxis}[legend pos = outer north east, 
    ...
    % eta uniform
    add slope triangle
    \draw (axis cs:2e5,7e-2) 
                 --(axis cs:2e5,2.21e-1) node [midway, right] {\scriptsize$1$}
                 -- (axis cs:2e4,2.21e-1) node [midway, above] {\scriptsize$2$}
                 -- cycle
                 ;
    ...
    \draw (axis cs:1e5,1e-2) 
                 --(axis cs:1e5,5e-2) node [midway, right] {\scriptsize$1$}
                 -- (axis cs:2e4,5e-2) node [midway, above] {\scriptsize$1$}
                 -- cycle
                 ;
  \end{loglogaxis}
\end{tikzpicture}
